...
public final class ApprovalEmailTemplate {

    private static final String TEMPLATE_PATH = "/templates/building-request-approval.html";

    private ApprovalEmailTemplate() {
    }
    ...
    private static String loadTemplate() {
        try (InputStream is = ApprovalEmailTemplate.class.getResourceAsStream(TEMPLATE_PATH)) {
            if (is == null) {
