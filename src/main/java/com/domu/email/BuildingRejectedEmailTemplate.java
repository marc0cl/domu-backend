...
public final class BuildingRejectedEmailTemplate {

    private static final String TEMPLATE_PATH = "/templates/building-request-rejected.html";

    private BuildingRejectedEmailTemplate() {
    }
    ...
    private static String loadTemplate() {
        try (InputStream is = BuildingRejectedEmailTemplate.class.getResourceAsStream(TEMPLATE_PATH)) {
            if (is == null) {
