...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>boxSdk</b> with <b>com.box:box-java-sdk</b> coordinates and
     * with version reference <b>boxSdk</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getBoxSdk() {
        return create("boxSdk");
    }
    ...
    /**
     * Dependency provider for <b>jacksonJsr310</b> with <b>com.fasterxml.jackson.datatype:jackson-datatype-jsr310</b> coordinates and
    ...
    /**
     * Dependency provider for <b>jakartaPersistence</b> with <b>jakarta.persistence:jakarta.persistence-api</b> coordinates and
     * with version reference <b>jakartaPersistence</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJakartaPersistence() {
        return create("jakartaPersistence");
    }

    /**
     * Dependency provider for <b>jakartaValidation</b> with <b>jakarta.validation:jakarta.validation-api</b> coordinates and
     * with version reference <b>jakartaValidation</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJakartaValidation() {
        return create("jakartaValidation");
    }

    /**
     * Dependency provider for <b>javaJwt</b> with <b>com.auth0:java-jwt</b> coordinates and
     * with version reference <b>javaJwt</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJavaJwt() {
        return create("javaJwt");
    }
    ...
    /**
     * Dependency provider for <b>javalinTesttools</b> with <b>io.javalin:javalin-testtools</b> coordinates and
     * with version reference <b>javalin</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJavalinTesttools() {
        return create("javalinTesttools");
    }
    ...
    /**
     * Dependency provider for <b>junitJupiter</b> with <b>org.junit.jupiter:junit-jupiter</b> coordinates and
    ...
    /**
     * Dependency provider for <b>log4jApi</b> with <b>org.apache.logging.log4j:log4j-api</b> coordinates and
    ...
    /**
     * Dependency provider for <b>log4jCore</b> with <b>org.apache.logging.log4j:log4j-core</b> coordinates and
     * with version reference <b>log4j</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Dependency provider for <b>log4jSlf4j</b> with <b>org.apache.logging.log4j:log4j-slf4j2-impl</b> coordinates and
     * with version reference <b>log4j</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getLog4jSlf4j() {
        return create("log4jSlf4j");
    }
    ...
    /**
     * Dependency provider for <b>mysqlConnector</b> with <b>com.mysql:mysql-connector-j</b> coordinates and
     * with version reference <b>mysqlConnector</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getMysqlConnector() {
        return create("mysqlConnector");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>boxSdk</b> with value <b>5.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBoxSdk() { return getVersion("boxSdk"); }
        ...
        /**
         * Version alias <b>jakartaPersistence</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJakartaPersistence() { return getVersion("jakartaPersistence"); }
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJavalin() { return getVersion("javalin"); }
        ...
        /**
         * Version alias <b>mysqlConnector</b> with value <b>9.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMysqlConnector() { return getVersion("mysqlConnector"); }
